...
{
    public $navbarActiveItem = 'post-categories';
    ...
    {
        $model = $this->findModel($id);
        $model->status = PostCategory::STATUS_DELETED;
    ...
    {
        if (($model = PostCategory::findOne($id)) !== null and $model->status != PostCategory::STATUS_DELETED) {
            return $model;
        } else {
